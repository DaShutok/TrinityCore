        ...
        struct boss_algalonAI : public BossAI
        {
            ...
            void JustSummoned(Creature* Summon)
            {
                ...
                case CREATURE_AZEROTH_MODEL:
                    Summon->SetFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_NOT_SELECTABLE | UNIT_FLAG_NON_ATTACKABLE | UNIT_FLAG_PACIFIED);
                    break;
            ...
            {
                DoAction(CREATURE_LIVING_CONSTELLATION);
				DoAction(ACTION_ACTIVATE_CONSTELLATION);
            }
            ...
            void UpdateAI(const uint32 diff)
            {
                ...
                if (me->HasUnitState(UNIT_STATE_CASTING))
                    ...
                    case EVENT_SUMMON_UNLEASHED_DARK_MATTER:
                        DoAction(CREATURE_BLACK_HOLE);
						DoAction(ACTION_BLACKHOLE_SUMMON);
