...
enum Yells
{
    ...
    SAY_DRAKE_HARPOON_1                 = -1575014,
    SAY_DRAKE_HARPOON_2                 = -1575015,
    SAY_KILL_1                          = -1575005,
    SAY_KILL_2                          = -1575006,
    SAY_KILL_3                          = -1575016,
    SAY_DEATH                           = -1575008,
        ...
        void UpdateAI(const uint32 diff)
        {
            switch (Phase)
            {
                ...
                case SKADI:
                    ...
                    if (isWhirling)  //somewhat hacky to get skadi move during whirlwind
                    {
                        if (WhirlwindTimer <= diff)
                        {
