...
class npc_transmogrify : public CreatureScript
{
    public:
        ...
        bool OnGossipHello(Player* pPlayer, Creature* pCreature)
        {
            ...
            pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_MONEY_BAG, "Limpiar el objecto..", GOSSIP_SENDER_MAIN, ACTION_TRANSMOGRIFY_REMOVE_DISPLAY);
        ...
        void TransmogrifyItem(Player* player, Creature* creature)
        {
            ...
            {
                handler.PSendSysMessage("Pon un objeto en la segunda casilla!");
                return;
            }

            if (!player->HasEnoughMoney(PriceInGold))
            {
                handler.PSendSysMessage("Cuesta %u oros!", PriceInGold);
                return;
            }
        ...
        void ClearItem(Player *player, Creature* creature)
        {
            ...
            if (!trItem)
            {
                handler.PSendSysMessage("Pon el objeto en la primera casilla!");
                return;
            }
