...
extern int main(int argc, char **argv)
{
	...
	sLog->outInfo(LOG_FILTER_AUTHSERVER, " ______                       __");
    sLog->outInfo(LOG_FILTER_AUTHSERVER, "/\\__  _\\       __          __/\\ \\__");
    sLog->outInfo(LOG_FILTER_AUTHSERVER, "\\/_/\\ \\/ _ __ /\\_\\    ___ /\\_\\ \\, _\\  __  __");
    sLog->outInfo(LOG_FILTER_AUTHSERVER, "   \\ \\ \\/\\`'__\\/\\ \\ /' _ `\\/\\ \\ \\ \\/ /\\ \\/\\ \\");
    sLog->outInfo(LOG_FILTER_AUTHSERVER, "    \\ \\ \\ \\ \\/ \\ \\ \\/\\ \\/\\ \\ \\ \\ \\ \\_\\ \\ \\_\\ \\");
    sLog->outInfo(LOG_FILTER_AUTHSERVER, "     \\ \\_\\ \\_\\  \\ \\_\\ \\_\\ \\_\\ \\_\\ \\__\\\\/`____ \\");
    sLog->outInfo(LOG_FILTER_AUTHSERVER, "      \\/_/\\/_/   \\/_/\\/_/\\/_/\\/_/\\/__/ `/___/> \\");
    sLog->outInfo(LOG_FILTER_AUTHSERVER, "                                 C O R E  /\\___/");
    sLog->outInfo(LOG_FILTER_AUTHSERVER, "http://TrinityCore.org                    \\/__/\n");
